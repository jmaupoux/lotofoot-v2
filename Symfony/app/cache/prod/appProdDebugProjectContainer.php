...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/cache/prod/annotations', true);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_8cda837c7d55a55b875ef9a5f4113c2a');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_8cda837c7d55a55b875ef9a5f4113c2a');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_8cda837c7d55a55b875ef9a5f4113c2a');
        ...
        $d->setProxyDir('D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/logs/prod.log', 100, true);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_LoginFirewallService()
    {
        ...
        return $this->services['security.firewall.map.context.login_firewall'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'login_firewall', $b, $this->get('event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '522505575f5e1', $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'login_firewall', NULL, NULL, NULL, $b));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/../web', true);
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), array(0 => 'IS_AUTHENTICATED'), NULL);
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/cache/prod',
            ...
            'debug.container.dump' => 'D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/cache/prod/appProdDebugProjectContainer.xml',
            ...
            'session.save_path' => 'D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/cache/prod/sessions',
            ...
            'router.resource' => 'D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/cache/prod/assetic',
            ...
            'assetic.java.bin' => 'D:\\tools\\com\\sun\\java\\jdk\\1.6.0_20/bin\\java.EXE',
            ...
            'doctrine.orm.proxy_dir' => 'D:/zend-eclipse-php/workspace/lotofoot-v2/Symfony/app/cache/prod/doctrine/orm/Proxies',
